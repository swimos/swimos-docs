...
redirect_from:
  - /rust/tutorials/server-downlinks/
  - /rust/reference/server-downlinks.html
---

In the [Downlinks guide]({% link _rust_backend/downlinks.md %}), we discuss **downlinks** - bidirectionally-streaming, persistent **subscriptions** to lanes - and went through an example of a client-side downlink. This guide will showcase downlinks between two Swim servers.
...
Client-side downlinks have been showcased in the [Downlinks guide]({% link _rust_backend/downlinks.md %}).
