...
redirect_from:
  - /rust/tutorials/downlinks/
  - /rust/reference/downlinks.html
---

In the [Web Agents guide]({% link _rust_backend/web-agents.md %}), we describe a distributed object model where **Web Agents** are the **objects** and **lanes** are **fields**. **Downlinks** are bidirectionally-streaming, persistent **subscriptions** to lanes.
...
Server-side, downlinks are explained in the [Server Downlinks guide]({% link _rust_backend/server-downlinks.md %}).
