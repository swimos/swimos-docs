...
redirect_from:
  - /rust/concepts/lane-organization.html
---
...
_For more details on usage and syntax see the [Value Lanes reference]({% link _rust_backend/value-lanes.md %})._
...
If the data has a strict structure, consider strongly typing the lanes, see [Forms]({% link _rust_backend/forms.md %}).
...
_For more details on usage and syntax see the [Map Lanes reference]({% link _rust_backend/map-lanes.md %})._
...
_For more details on usage and syntax see the [Join Value Lanes reference]({% link _rust_backend/join-value-lanes.md %})._
...
For a guide on how to implement an aggregate agent see the [aggregations guide]({% link _rust_backend/aggregations.md %}).
...
_For more details on usage and syntax see the [Demand Value Lanes reference]({% link _rust_backend/demand-value-lanes.md %})._
...
_For more details on usage and syntax see the [Demand Map Lanes reference]({% link _rust_backend/demand-map-lanes.md %})._
