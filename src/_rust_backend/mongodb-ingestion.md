...
redirect_from:
  - /rust/guides/mongodb-ingestion.html
---
...
_See the [timers guide]({% link _rust_backend/timers.md %}) for more information on how we could poll continuously with a given time interval._
