...
redirect_from:
  - /java/guides/flink-connector.html
---
...
Swim `Form` provides a general method for molding an object into a `Value`, as above, but structure of messages can be customized (see [Forms]({% link _java_backend/forms.md %})).
