...
redirect_from:
  - /java/tutorials/join-value-lanes/
  - /java/reference/join-value-lanes.html
---

In the [Value Lanes guide]({% link _java_backend/value-lanes.md %}), we describe a distributed object model where **Web Agents** are the **objects**. The **fields** in this model are called **lanes**.
