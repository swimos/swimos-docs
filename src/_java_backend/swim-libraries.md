...
redirect_from:
  - /java/start/
  - /java/reference/swim-libraries.html
---
...
To try Swim, check out one of our step-by-step [tutorials]({% link _java_tutorials/index.md %}). To build your own app, try cloning a [starter application](https://github.com/swimos/tutorial). Or continue reading to learn more about how to get started with Swim.
...
Continue reading to tryout step-by-step lessons with Swim. Or dive into the core Swim [concepts]({% link _java_backend/index.md %}).
