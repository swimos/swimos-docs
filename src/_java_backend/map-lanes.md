...
redirect_from:
  - /java/tutorials/map-lanes/
  - /java/reference/map-lanes.html
---
...
Further reading: [Command Lanes]({% link _java_backend/command-lanes.md %}), [Downlinks]({% link _java_backend/downlinks.md %})
