...
redirect_from:
  - /java/tutorials/http-lanes/
  - /java/reference/http-lanes.html
---

In previous guides, we have seen how Swim applications consist of interconnected [Web Agents]({% link _java_backend/web-agents.md %}) with properties and methods in the form of [Lanes]({% link _java_backend/command-lanes.md %}).
