...
redirect_from:
  - /java/tutorials/downlinks/
  - /java/reference/downlinks.html
---

In the [Web Agents guide]({% link _java_backend/web-agents.md %}), we describe a distributed object model where **Web Agents** are the **objects** and **lanes** are **fields**. **Downlinks** are bidirectionally-streaming, persistent **subscriptions** to lanes.
...
Server-side, downlinks are explained in the [Server Downlinks guide]({% link _java_backend/server-downlinks.md %}).
